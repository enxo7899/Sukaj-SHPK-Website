...
export const productGroups: ProductGroup[] = [
  ...
  // Consolidated from: pe100-pressure-pipe + konti-pe100-water-pipe + ferplast-pe100-water-pipe
  {
    ...
    keyProperties: {
      ...
      "Colour": "Black with blue stripe / coextruded blue lines",
      "Standard Length": "6 m or 12 m bars / coils ≤ 110 mm",
    ...
    suppliers: [
      {
        ...
        orderNote: "Ø200–630 mm and PN25 / PN32 on order",
        diameterMin: 20,
        diameterMax: 630,
      ...
      },
      {
        ...
        color: "#a855f7",
        availability: "partial",
        stockNote: "Ø20–90 mm in stock",
        orderNote: "Ø90–630 mm on order",
        diameterMin: 20,
        diameterMax: 630,
  ...
  // Renamed from konti-pe100rc-water-pipe → generic canonical id
  {
    ...
    name: "PE100-RC Water Supply Pipe",
    shortName: "PE100-RC",
    category: "civil",
    ...
    keyProperties: {
      ...
      "Diameter Range (stock)": "Ø25–110 mm",
      "Diameter Range (order)": "Ø25–630 mm",
      "Pressure (stock)": "PN10 · PN16",
      "Pressure (order)": "PN6 · PN20 · PN25 · PN32",
    ...
    suppliers: [
      {
        ...
        color: "#0891b2",
        availability: "partial",
        stockNote: "Ø25–110 mm in stock at PN10 and PN16",
        orderNote: "Full range including PN20, PN25, PN32 on order",
        diameterMin: 25,
        diameterMax: 630,
  ...
  // Consolidated from: corrugated-hdpe-sewage + konti-kan-corrugated-sn4 + ferplast-corrugated-sn4 + ferplast-corrugated-sn8
  {
    ...
    standards: ["EN 13476", "EN 13476-1:2018", "EN 13476-3", "ISO 9969"],
    keyProperties: {
    ...
    suppliers: [
      {
        ...
        color: "#0891b2",
        availability: "in-stock",
        stockNote: "SN4 full range in stock Ø110–1000 mm",
        orderNote: "SN8 class available on order",
        diameterMin: 100,
        diameterMax: 1000,
        standards: ["EN 13476-3", "ISO 9969"],
        specificSpecs: {
          "Primary Class": "SN4 (≥ 4 kN/m²)",
...

  {
    ...
    name: "HDPE Perforated Sub-Surface Drainage Pipe",
    ...
    keyProperties: {
      ...
      "Diameter Range (stock)": "Ø110–200 mm",
      "Diameter Range (order)": "Ø250–500 mm",
      "Supply Form": "Coils (Ø90–160 mm) · 6 m bars (Ø200–500 mm)",
    ...
    suppliers: [
      {
        ...
        color: "#a855f7",
        availability: "partial",
        stockNote: "Ø110–200 mm in stock",
        orderNote: "Ø250–500 mm on order",
        diameterMin: 110,
        diameterMax: 500,
        standards: ["EN 13476-3", "ISO 9969"],
        specificSpecs: {
