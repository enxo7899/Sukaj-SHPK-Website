...
export const partners: Partner[] = [
  ...
  },
  {
    ...
    name: "Palaplast",
    country: "Greece",
    specialty: "PVC Pipes, Fittings & Filtration",
    tagline: "Greek pipe & fitting manufacturer",
    description:
      "Palaplast is a Greek manufacturer of plastic pipes, threaded fittings, and irrigation filters serving the wider Mediterranean and Balkan markets.",
    website: "https://www.palaplast.gr",
    partnerType: "manufacturer",
    keyStandards: [],
    heroMetrics: ["Pipes", "Fittings", "Filters"],
    logo: { dark: "/partners/palaplast/logo.svg" },
    featuredPriority: 13,
    products: [
      { name: "Plastic Pipes", type: "PVC / PE", diameters: "Various" },
      { name: "Pipe Fittings", type: "Compression / Threaded", diameters: "Various" },
      { name: "Irrigation Filters", type: "Disc / Mesh", diameters: "Various" },
    ],
    featured: false,
    color: "#84cc16",
  },
  ...
  },
  {
    ...
    name: "Roto",
    country: "North Macedonia",
    specialty: "Rotational-Moulded Water Tanks",
    tagline: "Polyethylene tank specialist",
    description:
      "Roto is a North Macedonian manufacturer of rotational-moulded polyethylene water storage tanks and related plastic containers for residential, agricultural and industrial use.",
    website: "https://roto.mk",
    partnerType: "manufacturer",
    keyStandards: [],
    heroMetrics: ["Rotomoulded PE", "Storage tanks"],
    logo: { dark: "/partners/roto/logo.svg" },
    featuredPriority: 15,
    products: [
      { name: "PE Water Tank", type: "Rotomoulded PE", diameters: "Various capacities" },
    ],
    featured: false,
    color: "#14b8a6",
  },
