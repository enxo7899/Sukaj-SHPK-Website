...
export function CatalogPageHeader({
  ...
  return (
    <div className="site-shell pb-8 sm:pb-12" style={{ borderBottom: "1px solid var(--site-border)" }}>
      ...
      <h1
        ...
        style={{ fontSize: "clamp(2.2rem, 5vw, 4rem)", color: "var(--site-text)" }}
      >
        {t("catalog.pageTitle")}
      </h1>
      <p className="text-base sm:text-lg max-w-2xl" style={{ color: "var(--site-text-muted)" }}>
