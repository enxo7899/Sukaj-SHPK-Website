          ...
          {!imgError && group.image ? (
            <>
              ...
              <Image
                ...
                loading="lazy"
                className={`${
                  group.suppliers.some((s) => s.partnerId === "roto" || s.partnerId === "polins" || s.partnerId === "plastika-nv" || s.partnerId === "viokon" || s.partnerId === "grouner" || s.partnerId === "xier") ? "object-contain p-4" : "object-cover"
